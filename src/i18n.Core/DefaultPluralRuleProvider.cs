...
namespace i18n.Core
{
    ...
    {
        static readonly Dictionary<string, PluralizationRuleDelegate> Rules;
        ...
        static void AddRule(string[] cultures, PluralizationRuleDelegate rule)
        {
        ...
        CultureInfo GetBaseCulture(CultureInfo culture)
        {
