...
namespace i18n.Core.PortableObject
{
    ...
    public class PortableObjectStringLocalizer : IPluralStringLocalizer
    {
        ...
        readonly bool _fallBackToParentCulture;
        ...
        IEnumerable<LocalizedString> GetAllStringsFromCultureHierarchy(CultureInfo culture)
        {
        ...
        string GetTranslation(string[] pluralForms, CultureInfo culture, int? count)
        {
            var dictionary = _localizationManager.GetDictionary(culture);
        ...
        string GetTranslation(string name, string context, CultureInfo culture, int? count)
        {
